...
const resList = [
  {
    ...
    analytics: {
      context: "seo-data-5f261f5a-0ac8-477f-909e-632fd3ba7ff3",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-10-31 23:01:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://img.freepik.com/premium-vector/beautiful-unique-food-restaurant-company-logo-design_981150-2156.jpg?w=740"
        />
      </div>
